...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Connexion des Admonistrateurs</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('login-admin') }}">
                        @csrf
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right text-center">{{ __('Address e-mail') }}</label>
