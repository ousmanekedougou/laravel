            ...
            <div class="row admin text-center">
                <div class="col-md-12">
                    ...
                    @foreach($user_carre as $user)
                            ...
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-15" style="width:;">
                                ...
                                <div class="row vertical-center-box vertical-center-box-tablet"  >
                                    <div class="col-xs-4" style="margin:0px;">
                                        <img src="{{asset('storage/'.$user->images)}}" alt="" style="">
                                    </div>
                                    <div class="col-xs-8 cus-gh-hd-pro">
                                        <h6 class="text-left no-margin" style="color: beige;margin-left:-15px;">{{$user->prenom}} {{$user->name}}</h6>
                                        <p style="color:beige;margin-left:-15px;" class="text-left">{{$user->email}}</p>
                                        <p style="color:beige;margin-top:-13px;margin-left:-15px;" class="text-left">{{$user->created_at}}</p>
                                        <p style="margin-bottom:-10px;margin-top:-13px;margin-left:-15px;" class="text-left">
                                        
                                            <form action="/patient-list-admin/{{$user->id}}" method="post">
                                        @csrf
                                        @method('delete') 
                        ...
                        @endforeach
                        <span style="margin-left:;"> {{$user_carre->links()}}</span>
                    </div>
                </div>
            </div>
        </div>
