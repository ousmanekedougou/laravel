                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            <h4>La liste des medecins</h4>
                            <div class="add-product">
                                <a href="{{route('register-medecin')}}">Ajouter un medecin</a>
                            </div>
                            <table class="table-condensed">
                                <tr>
                                    ...
                                    <th>Adresse</th>
                                    <th>Specialite</th>
                                    <th><span class="text-danger">Suprimmer</span></th>
                                </tr>
                                @foreach($medecin_list as $medecin)
                                <tr>
                                    <td><img src="{{'storage/'.$medecin->images }}" alt="" /></td>
                                    ...
                                    <td>
                                    <form action="/medecin-list-admin/{{$medecin->id}}" method="post">
                                        @csrf
                                        @method('delete') 
                                        <!-- <button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button> -->
                                        <button type="submit" name="delete" data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                        </form>
                                    </td>
                                </tr>
                                @endforeach
                            </table>
                            <span style="margin-left:;"> {{$medecin_list->links()}}</span>
                        </div>
                    </div>
                </div>
            </div>
