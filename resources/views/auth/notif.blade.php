  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
        ...
        <div class="sidebar-brand-text mx-3">MaSante <sup>&</sup></div>
      </a>
          ...
          <div class="card border-left-primary shadow h-100 py-2">
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col-auto">
                    <img src="{{asset('storage/'.$insert->medecins->images)}}" alt="" class="img-rounded img-responsive " style="width:50px;height:50px;margin-top:-10px;margin-left:-15px;">
                </div>
                <div class="col mr-2" style="margin-bottom:-25px;">
                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1" style="margin-left:15px;margin-top:-20px;">{{$insert->medecins->prenom}} {{$insert->medecins->name}} </div>
                    <div class="" style="margin-left:15px;font-size:13px;text-align:left;">
                      Bonjour {{Auth::user()->prenom}} {{Auth::user()->name}} nous nous excusons
                     du retard et vous informe que  votre rendez-vous de {{$insert->medecins->specialite->name}}
                     est fixer le {{$insert->date}} {{$insert->heure}} a  
                     l'hopital {{$insert->medecins->adresse}}. <br> 
                      On vous invite a respecter la date et l'heure fixer et bonne journee  
